...
class ServiceRequestHandler<T, S> extends ChannelDuplexHandler {
	...
	private void handleRequest(ByteBuf requestBuffer, ByteBuf responseBuffer) throws ServiceException {
	...
	private void handleSuccess(final ChannelHandlerContext ctx, ServiceServerResponse response, ByteBuf responseBuffer) {
	...
	private void handleError(final ChannelHandlerContext ctx, ServiceServerResponse response, String message) {
